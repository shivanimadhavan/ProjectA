...
namespace ClinicManagementSystemMVC.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,PatientID,SpecializationRequired,VisitDate,VisitTime")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,PatientID,SpecializationRequired,VisitDate,VisitTime")] Appointment appointment)
        {
