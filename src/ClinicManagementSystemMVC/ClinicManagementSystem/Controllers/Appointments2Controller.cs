...
namespace ClinicManagementSystem.Controllers
{
    public class Appointments2Controller : Controller
    {
        ...
        public Appointments2Controller(ClinicalDetailsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,PatientID,Specializationrequired,DFirstName,Visitdate,AppoinmentTime")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,PatientID,Specializationrequired,DFirstName,Visitdate,AppoinmentTime")] Appointment appointment)
        {
