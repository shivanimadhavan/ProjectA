...
{
    public class DocDetails2Controller : Controller
    {
        private readonly ClinicalDetailsContext _context;

        public DocDetails2Controller(ClinicalDetailsContext context)
        {
            _context = context;
        }
        ...
        // GET: DocDetails2/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DocDetails2/Create
