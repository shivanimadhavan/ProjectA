...
{
    public class FrontStaffsController : Controller
    {
        ...
        // GET: FrontStaffs/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: FrontStaffs/Create
