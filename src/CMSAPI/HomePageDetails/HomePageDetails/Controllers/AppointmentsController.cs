...
namespace HomePageDetails.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Appointment>>> GetAppointmentTable()
        {
            return await _context.AppointmentTable.ToListAsync();
        }
        ...
        {
            _context.AppointmentTable.Add(appointment);
            await _context.SaveChangesAsync();
